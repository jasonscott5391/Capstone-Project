...
import static com.udacity.podkis.entity.Episode.COLUMN_EPISODE_TITLE;
import static com.udacity.podkis.entity.Podcast.COLUMN_PODCAST_ID;

@Entity(tableName = TABLE_NAME_EPISODE, indices = @Index(value = COLUMN_EPISODE_TITLE, unique = true))
public class Episode {

    public static final String TABLE_NAME_EPISODE = "episode";
    public static final String COLUMN_EPISODE_ID = BaseColumns._ID;
    ...
    static final String COLUMN_EPISODE_IMAGE_URL = "episode_image_url";
    static final String COLUMN_EPISODE_DURATION = "duration";
    static final String COLUMN_EPISODE_URL = "enclosure";
    ...
    @ColumnInfo(name = COLUMN_EPISODE_IMAGE_URL)
